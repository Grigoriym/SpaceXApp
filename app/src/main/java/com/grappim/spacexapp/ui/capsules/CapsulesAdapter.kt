...
import kotlinx.android.synthetic.main.layout_capsule_item.view.tvCapsuleSerial
import kotlinx.android.synthetic.main.layout_capsule_item.view.tvCapsuleStatus
import kotlinx.android.synthetic.main.layout_capsule_item.view.tvCapsuleType
            ...
            itemView.apply {
                ...
                tvCapsuleOriginalLaunch.text =
                    if (item.originalLaunch == null) {
                        ...
                        DateTimeUtils.getDateTimeFormatter3()
                            .format(item.originalLaunch.getOffsetDateTime())
                    }
